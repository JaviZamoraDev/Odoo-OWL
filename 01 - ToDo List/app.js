...
class Task extends Component {
    ...
    <li t-attf-style="background-color:#{state.color}" class="d-flex align-items-center justify-content-between border p-3 mb-2 rounded">
        <div t-if="state.isEditing" class="d-flex align-items-center flex-grow-1 m2">
            <input type="text" class="form-control m2" t-model="state.name" />
        ...
        <div t-if="!state.isEditing" class="form-check form-switch fs-5">
            <input class="form-check-input" type="checkbox" value="" t-att-checked="state.isCompleted" t-att-id="state.id" t-on-click="toogleTask" t-model="state.isCompleted" />
...
class Root extends Component {
    ...
    addTask(){
        ...
        this.state = { ...state, name:"", color: "#FFF000", isCompleted: false }
